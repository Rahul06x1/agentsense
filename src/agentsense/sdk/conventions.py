...
# Non-standard extras (agentsense namespace) — no OTel convention exists yet.
CACHE_READ_INPUT_TOKENS = "agentsense.usage.cache_read_input_tokens"
CACHE_WRITE_INPUT_TOKENS = "agentsense.usage.cache_write_input_tokens"
COST_USD = "agentsense.cost_usd"
